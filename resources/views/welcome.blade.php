            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <a class="dropdown-item" href="article-details.html"><span class="item-text"><i class='fa fa-whatsapp'></i> Custumer Service</span></a>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="text-container">
                        ...
                        <a class="btn-outline-lg page-scroll" href="#instructor">LOGIN</a>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form  method="post" action="{{route('daftar.store')}}" >
                                            ...
                                            <div class="form-group">
                                                <input type="text" class="form-control-input" name="no_hp" id="no_hp"
                                                    required>
